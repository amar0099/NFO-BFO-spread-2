...
with tab3:
    ...
    st.markdown(f"<div style='font-size:11px;color:#64748b;margin:2px 0 8px 0;'>Synthetic Fut - Multiplier: <b>{iv_mult}</b> &nbsp;|&nbsp; Sensex lot: <b>{SENSEX_LOT}</b> &nbsp;|&nbsp; Nifty lot: <b>{NIFTY_LOT}</b></div>", unsafe_allow_html=True)
